...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_de_pagamento_id, endereco_cidade_id, endereco_cep, 
			...
			values (1, 'e2a7aaf4-aa13-11ed-8742-02509be10f1c', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_de_pagamento_id, endereco_cidade_id, endereco_cep, 
        			endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
        			status, data_criacao, subtotal, taxa_frete, valor_total)
			values (2, 'e0dd276b-aa14-11ed-8742-02509be10f1c', 4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
