...
public interface CidadeControllerOpenApi {
	...
	public CidadeModel buscar(@ApiParam(value = "ID de uma cidade", example = "0", required = true) Long cidadeId);
	...
	public CidadeModel atualizar(
			@ApiParam(value = "ID de uma cidade", example = "0", required = true) 
			Long cidadeId,
	...
	public void remover(@ApiParam(value = "ID de uma cidade", example = "0", required = true) Long cidadeId);
